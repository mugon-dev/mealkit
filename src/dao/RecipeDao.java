...
public class RecipeDao {
	...
	public List<Recipe> selectShopDiv(String cook_idx,String mat_no1, String cook_type, String idx){
		List<Recipe> list=new ArrayList<Recipe>();
		Connection conn=null;
		PreparedStatement ps=null;
		ResultSet rs=null;
		...
		if(index.equals("000")) {
			sql+=" where rec_idx=? order by read_count desc limit 3";
		}else {
			sql+=" && rec_idx=? order by read_count desc limit 3";
		}
		System.out.println(index);
