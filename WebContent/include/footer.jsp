					...
					<div class="single-footer-caption mb-50">
						<div class="footer-tittle">
							...
							<ul>
								...
								<li><a href="registerForm.do">Create an Account</a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-3 col-lg-3 col-md-5 col-sm-7">
					<div class="single-footer-caption mb-50">
						<div class="footer-tittle">
							<h4>Blog</h4>
							<ul>
								<li><a href="blogForm.do?idx=1&no=${session_no }">한식</a></li>
								<li><a href="blogForm.do?idx=2&no=${session_no }">중식</a></li>
								<li><a href="blogForm.do?idx=3&no=${session_no }">일식</a></li>
								<li><a href="blogForm.do?idx=4&no=${session_no }">양식</a></li>
							</ul>
						</div>
					</div>
				</div>
